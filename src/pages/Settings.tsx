            ...
            children: (
              <Card>
                <Flex vertical gap='large'>
                  <div>
                    <Title level={5}>
                      {t('settings.app.system_tray.title')}
                    </Title>
                    <Flex vertical gap='middle'>
                      <Flex justify='space-between' align='center'>
                        <div>
                          <Text strong>
                            {t('settings.app.system_tray.enable')}
                          </Text>
                          <Text
                            type='secondary'
                            style={{
                      ...
                      <Flex justify='space-between' align='center'>
                        <div>
                          ...
                          <Text
                            ...
                            {t(
                              'settings.app.system_tray.close_to_tray_description',
                            )}
                          </Text>
                        </div>
                        <Switch
                          checked={
                            settings.settings?.system_tray?.close_to_tray
                          }
                          onChange={(checked: boolean) =>
                            handleSystemTraySettingChange(
                              'close_to_tray',
                              checked,
                            )
                          }
                      ...
                      <Flex justify='space-between' align='center'>
                        <div>
                          <Text strong>
                            {t('settings.app.autostart.title')}
                          </Text>
                          <Text
                            type='secondary'
                            style={{
